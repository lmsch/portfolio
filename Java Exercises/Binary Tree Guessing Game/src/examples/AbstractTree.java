...
/**
 * An abstract base class providing some functionality of the examples.Tree interface.
 * <p>
...
public abstract class AbstractTree<E> implements Tree<E> {
    ...
    /**
     * Returns true if examples.Position p has one or more children.
     *
    ...
    /**
     * Returns true if examples.Position p does not have any children.
     *
     * @param p A valid examples.Position within the tree
    ...
    /**
     * Returns true if examples.Position p represents the root of the tree.
     *
     * @param p A valid examples.Position within the tree
    ...
    /**
     * Returns the number of children of examples.Position p.
     *
     * @param p A valid examples.Position within the tree
     * @return number of children of examples.Position p
     * @throws IllegalArgumentException if p is not a valid examples.Position for this tree.
     */
    @Override
    ...
    /**
     * Returns the number of levels separating examples.Position p from the root.
     *
     * @param p A valid examples.Position within the tree
     * @throws IllegalArgumentException if p is not a valid examples.Position for this tree.
     */
    ...
    /**
     * Returns the height of the subtree rooted at examples.Position p.
     *
     * @param p A valid examples.Position within the tree
     * @throws IllegalArgumentException if p is not a valid examples.Position for this tree.
     */
  ...
  /* This class adapts the iteration produced by positions() to return elements. */
    ...
    /**
     * Adds positions of the subtree rooted at examples.Position p to the given
     * snapshot using a preorder traversal
     *
     * @param p        examples.Position serving as the root of a subtree
